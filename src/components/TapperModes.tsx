...
export const TapperModes: React.FC = () => {
  return (
    <section className="bg-[rgba(33,33,33,0.77)] flex min-h-44 w-full max-w-[363px] flex-col mt-5 px-[11px] py-[21px] rounded-[9px]">
      <header className="w-full max-w-[329px] text-sm text-white font-extrabold text-center leading-none">
        <div className="bg-[rgba(33,33,33,0.77)] flex items-center gap-[40px_162px] justify-center">
      ...
      <div className="bg-[rgba(33,33,33,0.77)] flex min-h-[100px] w-full items-center gap-2.5 mt-[21px]">
        <button className="hover:scale-105 transition-transform">
          <img
            ...
            className="aspect-[1.03] object-contain w-[103px] self-stretch shrink-0 my-auto rounded-md"
            alt="Tapper mode 1"
          />
        </button>
        <button className="hover:scale-105 transition-transform">
